...
<body>
    <div class="login-page">
        <div class="form">
          ...
          <form class="register-form" method="POST" action="Controllers/funcionario/cadastrarfunc.php">
          ...
          <form class="login-form" method="POST" action="Controllers/funcionario/login.php">
            <?php
            ...
            <form>  
              <p class="message">Esqueceu a Senha? <a href="Views/funcionario/solicitarnovasenhafunc.html">Clique Aqui</a></p>
            </form>
          </form>
        </div>
      </div>
