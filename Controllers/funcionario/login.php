...
if(empty($info)) {
    header('location:../../Views/funcionario/login.php'); // se o array não estiver vazio (banco encontrou registro), redireciona pra index            
    $_SESSION['msn'] = '<p style="color: red">Login não efetuado</p><br>';
} else {
    header('location:../../Views/cliente/login_sucessofunc.html'); // se o array não estiver vazio (banco encontrou registro), redireciona pra index
}
/*
